...
Reads DATABASE_URL from memra Settings (rag/.env) and targets
...
import memra.infrastructure.db  # noqa: F401 — side-effect: registers all tables
...
from memra.app.core.config import get_settings as _get_settings  # noqa: E402
