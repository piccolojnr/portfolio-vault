...
from memra.domain.services.lightrag_service import CORPUS_ID as _DEFAULT_CORPUS_ID
from memra.domain.services import lightrag_service
from memra.infrastructure.db.repository import (
    get_doc_by_id,
    save_extracted_text,
    update_doc_metadata,
...
async def ingest_document(
    ...
    *,
    ...
    corpus_key selects which LightRAG workspace to write to.
    Defaults to CORPUS_ID when not supplied.
...
def _extract_text(doc) -> tuple[str, str | None]:
    ...
    path stored in the file_path column.
    """
