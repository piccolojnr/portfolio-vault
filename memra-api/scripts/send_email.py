#!/usr/bin/env python3
"""
Simple script to send emails using the memra infrastructure.
...
# Add src to path so we can import memra
sys.path.append(os.path.join(os.path.dirname(__file__), "..", "src"))

from memra.infrastructure.email import get_renderer, get_email_backend
