...
portfolio_rag.domain.services.ingestion_service.ingest_document.  The old chunk→embed→Qdrant path
...
from portfolio_rag.infrastructure.db import PipelineRun
from portfolio_rag.domain.models.pipeline import CostEstimate, PipelineRunList, PipelineRunSummary
from portfolio_rag.domain.services.chunking import chunk_document
from portfolio_rag.infrastructure.db.repository import finish_pipeline_run, get_docs, start_pipeline_run
