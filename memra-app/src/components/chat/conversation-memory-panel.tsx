  ...
  return (
    <div className="relative flex justify-end">
      <button
        ...
        className={`flex items-center gap-1.5 px-2 py-1.5 rounded-md transition-colors font-mono text-[10px] tracking-wide min-h-[36px]
          ${expanded
      ...
      {expanded && (
        <div className="absolute top-full right-0 mt-1 z-20 rounded-lg border border-border/40 bg-surface/95 backdrop-blur shadow-lg overflow-hidden"
